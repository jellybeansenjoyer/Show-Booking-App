      ...
      <div className="w-full h-full flex flex-col justify-center bg-main_blue px-80">
        ...
        <div className="mt-4 grid grid-cols-3 gap-10">
          {events.map((event, index) => (
            <div key={index} className="group relative overflow-hidden cursor-pointer group flex flex-col rounded-2xl border hover:border-green-400" onClick={()=>handleSportsClick(event.id)}>
              <img
