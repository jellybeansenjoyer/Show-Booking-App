...
const Search = () => {
    return(
        ...
        <div className="flex flex-col justify-between absolute inset-0 w-2/3 h-72 mx-auto bg-gradient-to-r from-blue-700 via-transparent to-violet-700 pointer-events-none px-8 py-10 rounded-2xl">
