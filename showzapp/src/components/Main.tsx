          ...
          {sports.map((sport, index) => (
            ...
            >
              ...
              <div className="flex flex-col py-4 px-8">
                <h1 className="group-hover:text-green-400 text-white text-2xl font-bold">
                  {sport.name}
                </h1>
                <div className="h-0.5 bg-gray-600 mt-3"></div>
                <div className="flex flex-col gap-2 mt-3">
                  <h1 className="group-hover:text-green-400 text-lg font-medium text-white">
                    {sport.event.event_venue}
                  </h1>
                  <h2 className="group-hover:text-green-400 text-white text-lg font-medium">
                    {sport.description}
                  </h2>
                </div>
              </div>
        ...
        <div className="mt-4 grid grid-cols-3 gap-4">
          {events.map((event, index) => (
            <div
              key={index}
              className="group relative group overflow-hidden flex flex-col rounded-2xl border hover:border-green-400 cursor-pointer"
              onClick={() => handleSportsClick(event.id)}
            >
              <img
                className="w-auto h-96 object-cover transform transition-transform duration-300 ease-in-out group-hover:scale-105"
